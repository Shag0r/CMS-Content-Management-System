...
<html lang="en">
    <head>
        ...
        <title>Register - Victory Admin</title>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="name" name="name"  type="text" placeholder="Enter your last name" />
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; <?php echo e(date('Y')); ?></div>
                            <div>
...
<?php /**PATH E:\Complete Laravel\projects\victory\resources\views/auth/register.blade.php ENDPATH**/ ?>