                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?php echo e(route('login')); ?>">
                                            ...
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" id="remember_me" name="remember" type="checkbox" value="<?php echo e(__('Remember me')); ?>" />
...
<?php /**PATH E:\Complete Laravel\projects\victory\resources\views/auth/login.blade.php ENDPATH**/ ?>